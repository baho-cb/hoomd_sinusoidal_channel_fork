 ...
 */
class __attribute__((visibility("default"))) CosineChannel
    {
    public:
        //! Constructor
        /*!
         ...
         */
        HOSTDEVICE bool CosineChannel(Scalar L, Scalar Amplitude, Scalar h, unsigned int Repetitions, mpcd::detail::boundary bc)
