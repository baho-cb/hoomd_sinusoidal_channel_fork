 ...
 *
 */
class __attribute__((visibility("default"))) CosineExpansionContraction
    {
    public:
        //! Constructor
        /*!
         ...
         */
        HOSTDEVICE CosineExpansionContraction(Scalar L, Scalar H_wide,Scalar H_narrow, unsigned int Repetitions, mpcd::detail::boundary bc)
